...
import { signUpUser, clearError, setError } from '../../store/slices/authSlice';
...
export default function SignupPage() {
  ...
  const handleOAuthSignUp = async (provider) => {
    ...
    try {
      ...
      dispatch(setError(`Failed to sign up with ${provider}`));
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="flex items-center justify-center p-6 min-h-[calc(100vh-80px)]">
          ...
          >
                      <div className="bg-white/90 backdrop-blur-3xl rounded-3xl shadow-2xl border border-white/30 p-6 text-center relative overflow-hidden">
            ...
            <motion.div 
              ...
              className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl relative z-10 shadow-emerald-500/20"
            >
            ...
            <motion.p 
              ...
              className="text-slate-600 mb-6 leading-relaxed text-sm"
            >
            ...
            >
              <Link 
                href="/login"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-violet-600 text-white py-3 px-6 rounded-2xl hover:from-blue-700 hover:to-violet-700 transition-all duration-300 shadow-xl hover:shadow-blue-500/30 transform hover:-translate-y-1 font-semibold group"
              >
                Go to Login
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="flex items-center justify-center p-6 min-h-[calc(100vh-80px)]">
        <motion.div 
          ...
          className="max-w-sm w-full relative z-10"
        >
          <div className="bg-white/90 backdrop-blur-3xl rounded-3xl shadow-2xl border border-white/30 p-6 relative overflow-hidden">
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-violet-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl relative shadow-blue-500/20">
            ...
            {error && (
              <motion.div 
                ...
                animate={{ scale: 1, opacity: 1 }}
                className="mb-4 p-3 bg-red-50/80 backdrop-blur-sm border border-red-200/60 rounded-2xl relative z-10"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
              ...
              >
                ...
                <div className="relative group">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-blue-600 transition-colors z-10" />
                  <input
                    type="text"
                    id="fullName"
                    value={fullName}
              ...
              >
                ...
                <div className="relative group">
                  <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-blue-600 transition-colors z-10" />
                  <input
                    type="tel"
                    id="phone"
                    value={phone}
